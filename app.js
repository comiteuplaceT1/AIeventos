...
const URL_AGENTE_EVENTOS = "https://script.google.com/macros/s/AKfycbzeJElw7Uu73zKrLpkbSLguIVQy5hivYJQ-PchAMbAWKRzyTwEybs5foW9LX-rwPZLT/exec";
...
function mensajeBotonesBienvenida() {
  return `<button onclick="window.abrirModalEventoRegistro('menu')" class="block w-full md:inline-block md:w-auto mb-1.5 md:mr-1 text-[13px] font-bold text-white bg-brand-700 hover:bg-brand-800 rounded-lg px-3 py-2 md:py-1.5 transition text-center">🎟️ Gestionar Eventos</button>`
    + `<button onclick="window.handleQuickAction('Ver eventos de hoy')" class="block w-full md:inline-block md:w-auto mb-1.5 md:mr-1 text-[13px] font-bold text-white bg-brand-600 hover:bg-brand-700 rounded-lg px-3 py-2 md:py-1.5 transition text-center">🎈 Eventos de hoy</button>`
    + `<button onclick="window.handleQuickAction('Ver eventos de la semana')" class="block w-full md:inline-block md:w-auto mb-1.5 md:mr-1 text-[13px] font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg px-3 py-2 md:py-1.5 transition text-center">📅 Eventos de la Semana</button>`
    + `<button onclick="window.abrirModalCalendario()" class="block w-full md:inline-block md:w-auto mb-1.5 md:mr-1 text-[13px] font-bold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg px-3 py-2 md:py-1.5 transition text-center">📆 Calendario Mensual</button>`
    + `<button onclick="window.abrirModalEventoRegistro('verificar_identidad')" class="block w-full md:inline-block md:w-auto mb-1.5 text-[13px] font-bold text-white bg-violet-600 hover:bg-violet-700 rounded-lg px-3 py-2 md:py-1.5 transition text-center">📋 Mis Registros / Cancelar</button>`;
}
